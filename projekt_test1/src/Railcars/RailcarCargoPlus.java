...
public RailcarCargoPlus(RailcarType type, int weight, int maxAvailableSpace, int currentUsedSpace, int maxGoodsWeight, int currentGoodsWeight, int additionalCompartments){
